...
int StartPos[] = {2000, 2000, 1200, 1200, 1200, 1200, 10000};
...
1713, 2100, 1236, 1112, 1122, 1319,2000,
1710, 2100, 966, 1330, 1527, 966,2000,
2150, 1700, 966, 1330, 1475, 956,2000,
2120, 1650, 1236, 1112, 1122, 1319,2000,
...
void loop(){
  ...
  if (BTserial.available() > 0) {       // если в буфере есть данные
    ...
    Serial.println(incomingChar);
      if (incomingChar == '1') {  
        PlaySteps(StepForward,ForwardStepCount);      // принят пакет
      }
     
      else if (incomingChar == '2') {   // принят пакет 
      } 
        MovePos(StartPos);
    }
