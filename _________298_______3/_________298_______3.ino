/*
Прошивка взята с http://ecnc.ru/flash/l298n_mill
Прошивка для платы Ардуино написана на языке Processing в среде разработки Arduino 1.0.2 в операционной системе Windows.
Эта прошивка работает с 3-хосевым станком с ЧПУ. Используются драйверы шаговых двигателей L298N и биполярные шаговые двигатели.
Прошивка может использоваться для рисования, фрезерования 2D (обведение или полное вырезание силуэтов и орнаментов), а также для 3D-фрезерования.
*/
